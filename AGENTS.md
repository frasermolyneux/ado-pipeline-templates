# AGENTS.md — ado-pipeline-templates

Repository `ado-pipeline-templates` in the frasermolyneux organization. Adapt this brief with repo-specific scope and validation commands.
